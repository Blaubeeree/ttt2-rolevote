...
CreateConVar(
	"ttt_rolevote_autostart",
	1,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY },
	"Enable/Disable autostart after mapchange"
):GetBool()
...
CreateConVar(
	...
	1,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY },
	"0: The players vote the roles that get activated 1: The players vote the roles that get banned"
):GetBool()
...
CreateConVar(
	...
	7,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY },
	"Sets the minimum players that have to be online for RoleVote being active",
	1
):GetInt()
...
CreateConVar(
	...
	1,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY },
	"Sets how many roles will be banned/activated",
	1
):GetInt()
...
CreateConVar(
	...
	1,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY },
	"Sets how many times a role can't be voted on after it has won a vote.",
	0
):GetInt()

CreateConVar(
	"ttt_rolevote_always_active",
	"",
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY },
	"Always activated roles (separated by ,)"
):GetString()

hook.Add("TTTUlxInitCustomCVar", "TTTRolevoteInitRWCVar", function(name)
	ULib.replicatedWritableCvar(
		"ttt_rolevote_autostart",
		"rep_ttt_rolevote_autostart",
		GetConVar("ttt_rolevote_autostart"):GetBool(),
		true,
		false,
		name
	)
	...
	ULib.replicatedWritableCvar(
		"ttt_rolevote_min_players",
		"rep_ttt_rolevote_min_players",
		GetConVar("ttt_rolevote_min_players"):GetInt(),
		true,
		false,
		name
	)
	ULib.replicatedWritableCvar(
		"ttt_rolevote_count",
		"rep_ttt_rolevote_count",
		GetConVar("ttt_rolevote_count"):GetInt(),
		true,
		false,
		name
	)
	ULib.replicatedWritableCvar(
		"ttt_rolevote_role_cooldown",
		"rep_ttt_rolevote_role_cooldown",
		GetConVar("ttt_rolevote_role_cooldown"):GetInt(),
		true,
		false,
		name
	)
	ULib.replicatedWritableCvar(
		"ttt_rolevote_always_active",
		"rep_ttt_rolevote_always_active",
		GetConVar("ttt_rolevote_always_active"):GetString(),
		true,
		false,
		name
	)
